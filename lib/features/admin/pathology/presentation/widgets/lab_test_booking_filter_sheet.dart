...
/// Modal bottom sheet for editing [LabTestBookingFilters]. Emits the new
/// value via [onApply] when the user hits Apply; Clear resets to defaults.
class LabTestBookingFilterSheet extends StatefulWidget {
  const LabTestBookingFilterSheet({super.key, required this.initial, required this.onApply});

  final LabTestBookingFilters initial;
  final ValueChanged<LabTestBookingFilters> onApply;

  @override
  State<LabTestBookingFilterSheet> createState() => _LabTestBookingFilterSheetState();
}

class _LabTestBookingFilterSheetState extends State<LabTestBookingFilterSheet> {
  ...
  void _apply() {
    ...
    // sheet.
    widget.onApply(LabTestBookingFilters(
  ...
  void _clear() {
    widget.onApply(LabTestBookingFilters(search: widget.initial.search));
    Navigator.of(context).pop();
  }
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  ...
                  for (final s in LabTestStatus.values)
                    ChoiceChip(
                      label: Text(s.label),
                      selected: _status == s,
