...
- **Pharmacy (dashboard)** — greeting; a **"Delivering to {area}"** line
  ...
  which naturally shortens the search bar too; promo banner; **Shop by
  category** grid (`homeCategoriesProvider`); **Suggested for you**
  horizontal products.
